        ...
        for index_1 = 1:1:NumOfVertexs
            for index_2 = 1:1:NumOfVertexs
                if K(index_1,index_2) ~= 0
                    energy = energy - T_hop * 0.5*(green_down_c(index_1,index_2) + green_up_c(index_1,index_2));
                end
            end
        end
...
[mean_E,svar_E] = Bin(mea_result_E);
errorbar(mean_E,svar_E)
%hold on
%errorbar(0.1554,0,'r*')
disp(mean(mea_result_E))
