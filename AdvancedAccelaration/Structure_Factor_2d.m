...
%                 [xi,yi] = IndexToCoor(site_i,NumInEdge);
%                 [xj,yj] = IndexToCoor(site_j,NumInEdge);
%                 factor = exp(1i*(px*(xi-xj)+py*(yi-yj)));
%                 
...
%             end
%         end
        S = real(S)/(4*NumOfVertexs*NumOfVertexs);
        mea_result_S(count_S) = S;
        count_S = count_S + 1;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%% MEASURE ?? %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
